...
public interface SolicitacaoRepository extends JpaRepository<Solicitacao, Long> {
    ...
    // CONSULTAS MATEMÁTICAS PARA MÉTRICAS (Contagens)
    ...
    // BUSCA PARA AS MÉTRICAS COM FILTRO (Listagem detalhada)
    List<Solicitacao> findByCidadaoCidadeAndDataCriacaoAfterOrderByDataCriacaoDesc(String cidade, java.time.LocalDateTime data);
}